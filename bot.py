...
async def stats_handler(c: Client, m: Message):
    ...
    stats = (
        ...
        f"<b>├ DISK : {disk}%</b>"
        f"<b>├⚙️ RAM : {memory}%</b>\n"
        f"<b>├ Group: @thewarriorsreal</b>\n"
        f"<b>├ Channel: @defenderofthemultiverse</b>\n"
        f"<b>├ OWNER : @ANKII3690</b>\n"
        f"<b>├ OWNER : @Saurav3BV6SA9LLElon7Musk</b>\n"
    )
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "Group", url="https://t.me/thewarriorsreal"
                    ),
                ],
                [InlineKeyboardButton("Close 🔐", callback_data="close")],
            ]
